 ...
 * ↓ YOUR CODE HERE ↓ */
var myTodoList = []
myTodoList.push("dishes");
myTodoList.push("laundry");
myTodoList.push("carwash");
console.log(myTodoList);
myTodoList.splice(1, 1);
console.log(myTodoList);
 var yourTodoList = ["oil change", "vacuum"];
...
function whichArrayIsLonger(array1, array2){
       ...
       return whichArrayIsLonger(array1, array2)  
} 
